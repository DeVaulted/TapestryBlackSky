...
const uriPrefix = "https://blacksky.app";
const uriPrefixContent = "https://cdn.blacksky.app";
const uriPrefixVideo = "https://video.blacksky.app";
...
function queryFeedForUser(did) {
	...
	return new Promise((resolve, reject) => {
		const url = `https://public.api.blacksky.app/xrpc/app.bsky.feed.getAuthorFeed?actor=${did}`;
		sendRequest(url)
		.then((text) => {
			const jsonObject = JSON.parse(text);
			let results = [];
